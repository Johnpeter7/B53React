    ...
    return (
        <section className="showcase">
            <div className="container-fluid p-0">
                ...
                <div className="row g-0">
                    <div className="col-lg-6 text-white showcase-img" style={{ backgroundImage: `url(${bgshowcase2})` }}></div>
                ...
                <div className="row g-0">
                    <div className="col-lg-6 order-lg-2 text-white showcase-img" style={{ backgroundImage: `url(${bgshowcase3})` }}></div>
                    <div className="col-lg-6 order-lg-1 my-auto showcase-text">
